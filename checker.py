...
#credits to vida for code. This is all his, all I did was make it overwrite tokens.txt
...
async def main():
    ...
    try:
        with open('tokens.txt', 'r') as tokens:
            ...
            with open(f'tokens.txt', 'w') as handle:
                handle.write('\n'.join(TOKENS_VALID_LIST))
                handle.close()
                
            input("Overwrote all tokens in tokens.txt\nOnly valids saved.\nClick Enter to exit!")
